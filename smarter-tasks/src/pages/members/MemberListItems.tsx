...
const MembersListitems = () => {
  ...
  const removeMember = async (id: any) => {
    ...
    if (response.ok) fetchMembers(dispatchMember);
  };
  return (
    <>
      {members.map((member: Member) => (
        <div
          key={member.id}
          className="flex p-5 bg-white border border-gray-100  shadow hover:bg-gray-50 dark:bg-gray-700 dark:border-gray-600 rounded-sm dark:hover:bg-gray-600 member"
        >
